    ...
    <div>
      <div className="flex flex-col max-w-6xl gap-6 px-3 mx-auto p-28">
        ...
        <p className="text-xs text-gray-500 sm:text-sm">
          ...
          web development, software engineering, progamming languages, and more.
        </p>{" "}
        <Link
          to={"/search"}
      ...
      <div className="flex flex-col max-w-6xl gap-8 p-3 mx-auto py-7">
        {posts && posts.length > 0 && (
          <div className="flex flex-col gap-6">
            ...
            <Link className="text-lg text-center text-teal-500 hover:underline" to={"/search"}>View all posts</Link>
          </div>
        )}
      </div>
    </div>
